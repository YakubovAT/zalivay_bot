...
Категория «комплект» — для цельных изделий, которые сами по себе формируют полный образ:
платье, сарафан, комбинезон, ромпер, туника, спортивный костюм, пижама, халат, боди, купальник.
Эти товары НЕ требуют дополняющего верха или низа.
...
REFERENCE_USER_TEMPLATE = (
    ...
    "   (комплект — платье, сарафан, комбинезон, ромпер, туника, спортивный костюм, пижама, халат, боди, купальник)\n\n"
