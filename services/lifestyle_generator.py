...
Генерация lifestyle-фото на модели через T2T AI + I2I AI.
"""
...
для генерации lifestyle-фото товара на модели.
...
LIFESTYLE_USER_TEMPLATE = (
    ...
    "— Сгенерировать реалистичное lifestyle-фото в заданной\n"
...
async def generate_lifestyle_prompt(
    ...
    """
    Генерирует промпт для lifestyle-фото через T2T AI.
    """
